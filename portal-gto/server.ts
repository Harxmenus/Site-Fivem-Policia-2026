...
const DEFAULT_QUESTIONS = [
  {
    id: "q1",
    question: "Em uma incursão em ambiente fechado (CQB), qual é o princípio primordial para a segurança da equipe?",
    options: ["Velocidade absoluta acima de tudo", "Surpresa, velocidade e violência de ação", "Aguardar o amanhecer", "Utilizar apenas granadas de efeito moral"],
    answerIndex: 1,
    explanation: "O tripé tático do CQB consiste em Surpresa, Velocidade e Violência de Ação para subjugar qualquer resistência rapidamente com segurança."
  },
  {
    id: "q2",
    question: "Ao deparar-se com uma barricada hostil durante um patrulhamento urbano, qual deve ser a primeira conduta da equipe do GTO?",
    options: ["Avançar individualmente a pé", "Buscar abrigo imediato, reportar a situação para estabelecer o perímetro e aguardar ordens", "Efetuar disparos aleatórios em direção à barricada", "Ignorar a barricada e retornar à base sem avisar"],
    answerIndex: 1,
    explanation: "Em cenários hostis com barreiras físicas, a prioridade absoluta é garantir a proteção coletiva, comunicar a situação e estabelecer o controle periférico."
  },
  {
    id: "q3",
    question: "Qual é o principal valor institucional esperado de um operador do Grupo Tático de Operações?",
    options: ["Individualismo absoluto nas tomadas de decisão", "Lealdade, disciplina rigorosa e espírito de corpo", "Busca por fama pessoal e reconhecimento público", "Uso desmedido e imediato da força letal"],
    answerIndex: 1,
    explanation: "Unidades especiais operam sob a base rígida de respeito mútuo, forte disciplina tática, lealdade e trabalho coordenado de equipe (espírito de corpo)."
  },
  {
    id: "q4",
    question: "O que significa a sigla CQB no contexto de operações policiais e militares?",
    options: ["Controle de Quarteirões e Barreiras", "Close Quarters Battle (Combate em Ambientes Fechados)", "Comando de Qualidade e Blindagem", "Curso de Qualificação Básica"],
    answerIndex: 1,
    explanation: "CQB (Close Quarters Battle) refere-se às técnicas de combate a curta distância em locais confinados, como cômodos e corredores."
  },
  {
    id: "q5",
    question: "Durante uma negociação tática com reféns, qual o papel primário do negociador do GTO?",
    options: ["Ganhar tempo útil, acalmar o tomador de reféns e colher inteligência tática", "Invadir o local imediatamente sem qualquer autorização superior", "Desafiar verbalmente as intenções do sequestrador", "Garantir rotas de fuga inseguras e descontroladas para o suspeito"],
    answerIndex: 0,
    explanation: "A negociação visa salvar vidas por meio do diálogo técnico, ganhando tempo valioso para mapear a área e obter dados sobre a situação interna."
  },
  {
    id: "q6",
    question: "Em patrulhamento em área de alto risco, qual é a postura correta de prontidão com o armamento?",
    options: ["Postura totalmente descontraída para evitar assustar moradores", "Arma coldreada e sem munição na câmara", "Prontidão operacional com disciplina rigorosa de mira e controle do cano", "Apontar a arma constantemente para qualquer cidadão na via pública"],
    answerIndex: 2,
    explanation: "A segurança do operador e dos cidadãos exige disciplina constante no direcionamento do cano e prontidão compatível com o nível de ameaça."
  },
  {
    id: "q7",
    question: "Qual equipamento é considerado essencial para proteção balística individual de um operador do GTO?",
    options: ["Colete balístico com placas cerâmicas rígidas nível III ou IV e capacete balístico", "Apenas óculos escuros de sol de alta performance", "Escudo balístico pesado compartilhado por todos", "Uniforme de tecido comum, priorizando apenas a agilidade"],
    answerIndex: 0,
    explanation: "Operações de alto impacto requerem blindagem individual rígida capaz de reter projéteis de calibres de alta velocidade, além de proteção craniana."
  },
  {
    id: "q8",
    question: "No uso progressivo da força policial, qual a sequência conceitual correta?",
    options: ["Iniciar o atendimento diretamente com disparos de arma de fogo letal", "Presença física, verbalização, controle de contato, técnicas menos letais e força letal", "Lançar gás lacrimogêneo imediatamente sem estabelecer diálogo", "Uso imediato de agressão verbal direta para intimidar suspeitos"],
    answerIndex: 1,
    explanation: "A lei exige o uso proporcional da força, subindo gradualmente de acordo com o nível de resistência oferecido pelo suspeito."
  },
  {
    id: "q9",
    question: "Qual conduta exemplifica corretamente o conceito de 'espírito de corpo' no GTO?",
    options: ["Disputar privilégios internos de forma individualista", "Solidariedade mútua, coesão grupal e apoio tático incondicional dentro da legalidade", "Acobertar infrações graves e desvios de conduta moral dos companheiros", "Evitar realizar missões em conjunto com operadores recém-formados"],
    answerIndex: 1,
    explanation: "O espírito de corpo é a união leal que garante que nenhum operador seja deixado para trás e que todos trabalhem pelo sucesso da equipe dentro da lei."
  },
  {
    id: "q10",
    question: "No atendimento pré-hospitalar tático (TCCC), qual a prioridade máxima sob fogo hostil ativo?",
    options: ["Realizar ressuscitação cardiopulmonar prolongada em campo aberto", "Neutralizar a ameaça ativa ou suprimir o inimigo e mover a vítima para um abrigo antes de intervir", "Iniciar imediatamente curativos detalhados na cabeça", "Aguardar a chegada de socorristas civis desprotegidos na linha de frente"],
    answerIndex: 1,
    explanation: "No cuidado sob fogo (Care Under Fire), o melhor atendimento médico é a supressão do fogo inimigo. Vítimas e socorristas devem buscar abrigo rapidamente."
  },
  {
    id: "q11",
    question: "Como deve ser feita a entrada de varredura tática em um cômodo conhecida como 'fatiar a torta'?",
    options: ["Correr para dentro do quarto de olhos fechados", "Visualizar o ambiente de forma angular progressiva a partir do exterior antes de ingressar", "Arrombar a porta e deitar-se imediatamente no meio do cômodo", "Atirar aleatoriamente através das paredes de gesso para limpar o espaço"],
    answerIndex: 1,
    explanation: "O fatiamento angular ('fatiar a torta') permite que o operador exponha apenas uma pequena fração do seu corpo por vez enquanto investiga cantos ocultos."
  },
  {
    id: "q12",
    question: "Qual característica psicológica é indispensável para um operador do GTO sob estresse severo?",
    options: ["Pânico descontrolado e reação de fuga imediata", "Equilíbrio emocional, raciocínio lógico analítico e foco estrito na segurança da equipe", "Sentimento de raiva extrema e agressividade irrefreável", "Apatia completa perante os perigos e riscos presentes no ambiente"],
    answerIndex: 1,
    explanation: "O controle emocional permite que o cérebro processe cenários de caos com clareza, tomando decisões éticas e eficazes em milissegundos."
  },
  {
    id: "q13",
    question: "O que representa a denominação 'zona quente' em um perímetro de crise tática?",
    options: ["A área de descanso climatizada onde ficam guardadas as viaturas", "O local com risco iminente, ameaça ativa ou fogo de armas direcionado", "A cozinha do alojamento central do batalhão", "O posto de comando onde se reúnem as autoridades civis"],
    answerIndex: 1,
    explanation: "A Zona Quente (Hot Zone) é o quadrante tático onde existe perigo ativo direto e imediato à integridade física dos operadores."
  },
  {
    id: "q14",
    question: "Qual o protocolo recomendado de comunicação via rádio em operações especiais do GTO?",
    options: ["Conversas descontraídas, extensas e repletas de detalhes pessoais", "Mensagens objetivas, linguagem clara padronizada e transmissões estritamente necessárias", "Debater abertamente as estratégias com críticas na frequência operacional ativa", "Manter o botão de transmissão travado constantemente para capturar ruídos ambientais"],
    answerIndex: 1,
    explanation: "Comunicações via rádio devem ser extremamente breves e diretas para manter o canal limpo para alertas críticos e evitar o cansaço auditivo da equipe."
  },
  {
    id: "q15",
    question: "Qual o propósito central de planejar e memorizar rotas de contingência ou rotas de fuga?",
    options: ["Facilitar desvios casuais para compras durante patrulhas", "Garantir a evacuação segura de feridos e a continuidade da missão se o caminho principal for bloqueado", "Gerar relatórios de consumo excessivo de combustível", "Dificultar a localização da equipe pelas forças aliadas de segurança"],
    answerIndex: 1,
    explanation: "Rotas de contingência salvam vidas, permitindo que a equipe mude de curso rapidamente em caso de emboscada, acidentes ou bloqueios inesperados."
  }
];
  ...
  timeline: [
    {
      ...
      description: "Criação oficial da unidade tática para dar resposta rápida a crimes de alta complexidade e sequestros."
    },
    {
      id: "t2",
      year: "2014",
      title: "Implantação do Núcleo de CQB",
      description: "Treinamento intensivo de combate em ambientes fechados com instrutores nacionais e internacionais."
    },
    {
      id: "t3",
      year: "2018",
      title: "Modernização Tecnológica",
      description: "Aquisição de armamento avançado, blindagens e drones táticos de reconhecimento aéreo."
    },
    {
      id: "t4",
      year: "2022",
      title: "Operações Integradas",
      description: "Alcançou o recorde histórico de neutralização de facções criminosas através de ações coordenadas."
    },
    {
      id: "t5",
      year: "2026",
      title: "Digitalização e Novo Portal",
      description: "Abertura do processo seletivo unificado tático online com acompanhamento em tempo real."
    }
  ],
  statistics: [
    {
...
app.post("/api/content", requireAdmin, (req, res) => {
  ...
  const updatedData = {
    ...currentData,
    history: incomingData.history && typeof incomingData.history === "object" ? incomingData.history : currentData.history,
    timeline: Array.isArray(incomingData.timeline) ? incomingData.timeline : currentData.timeline,
    statistics: Array.isArray(incomingData.statistics) ? incomingData.statistics : currentData.statistics,
    gallery: Array.isArray(incomingData.gallery) ? incomingData.gallery : currentData.gallery,
    questions: Array.isArray(incomingData.questions) ? incomingData.questions : currentData.questions,
    discordWebhook: typeof incomingData.discordWebhook === "string" ? incomingData.discordWebhook : currentData.discordWebhook
  };
...
app.post("/api/upload", requireAdmin, (req, res) => {
  ...
  if (!extension) {
    return res.status(400).json({ error: "Tipo de arquivo não permitido. Envie apenas imagens PNG, JPG, WEBP ou GIF." });
  }
...
app.post("/api/submit-test", async (req, res) => {
  ...
  const contactInfo = typeof passport === "string" && passport.trim() ? passport.trim() : (typeof phone === "string" ? phone.trim() : "");
  const trimmedAge = typeof age === "string" ? age.trim() : age;

  if (!trimmedName || !trimmedDiscordTag || !trimmedAge || !contactInfo || !Array.isArray(answers)) {
  ...
  if (answers.length !== questions.length) {
    return res.status(400).json({ error: "O número de respostas enviadas não corresponde ao número de questões do teste." });
  }
  ...
  if (webhookUrl && webhookUrl.startsWith("https://discord.com/api/webhooks/")) {
    try {
      const embedFields = [
        ...
        { name: "Pontuação", value: `**${score} / ${questions.length}** (${Math.round((score / questions.length) * 100)}%)`, inline: true },
        { name: "Status", value: passed ? "🟢 **APROVADO (Apto para TAF)**" : "🔴 **REPROVADO**", inline: true }
      ];

      const discordPayload = {
        username: "Portal GTO - Recrutamento",
        avatar_url: "https://images.unsplash.com/photo-1508847154043-be12a327dc6f?q=80&w=200&auto=format&fit=crop",
        embeds: [
          {
            title: "⚡ Nova Ficha de Inscrição Recebida",
            description: "Um candidato realizou o teste tático do GTO pelo portal oficial. Veja os detalhes abaixo:",
...
app.post("/api/ai-suggest", async (req, res) => {
  ...
  if (!client) {
    return res.status(503).json({
      error: "API Key do Gemini não configurada ou inválida. Configure nas configurações de segredo do AI Studio."
    });
  }

  if (typeof originalText === "string" && originalText.length > 8000) {
    return res.status(400).json({ error: "O texto original excede o tamanho máximo permitido para processamento por IA." });
  }
  if (typeof instructions === "string" && instructions.length > 1000) {
    return res.status(400).json({ error: "As instruções fornecidas excedem o tamanho máximo permitido." });
  }
...
Por favor, escreva um parágrafo polido, sem quebras de linha longas ou formatações markdown excessivas (use apenas texto fluido). Não adicione saudações de IA (como "Aqui está o seu texto:"), forneça diretamente apenas o texto final polido.`;
    ...
    res.status(500).json({ error: "Erro ao se comunicar com a Inteligência Artificial do Gemini: " + error.message });
  }
});
...
async function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`[Portal GTO Server] running on http://localhost:${PORT}`);
  });
}
