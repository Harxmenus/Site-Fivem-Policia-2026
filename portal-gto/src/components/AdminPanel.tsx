                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-0.5">
                          ...
                          >
                            ...
                            <option value="Award">⭐ Estrela</option>
                            <option value="Zap">⚡ Raio</option>
                            <option value="Activity">🚨 Alerta</option>
                            <option value="Lock">🔒 Algema / Cadeado</option>
                            <option value="Users">👥 Operadores / Equipe</option>
                            <option value="Skull">💀 Caveira</option>
                            <option value="Flame">🔥 Fogo / Combate</option>
                          </select>
                        </div>
